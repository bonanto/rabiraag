# Rabiraag (রবিরাগ) Bengali Keyboard by Bonanto
...
## 🌟 Why Choose the Rabiraag Bengali Keyboard?
...
* **Type Anything:** Type Any Bangla Character, including Old signs, currency denominators and everything.
...
রইল সকলের ব্যবহারের জন্য। টাইপিং কীভাবে করবেন, তার পদ্ধতি এখানে: [Typing Guide](Typing_Guide.html)
...
*(For full typing instructions, please see the [Typing Guide](Typing_Guide.html)).*
...
This project utilizes a **Split License** model to protect the final software while ensuring the underlying source code remains free and open. See the [LICENSE](LICENSE.html) for full legal details.
...
**Contact and Suggest:** bonanto18@protonmail.com  
...
*(For a complete, text-based breakdown of every key and its Unicode value, please see the [KEY MAPPINGS](KEY_MAPPINGS.html)).*

### 1. Normal Layer (No Modifiers)
![Normal Layer](https://raw.githubusercontent.com/bonanto/rabiraag/main/Screenshots/Normal.png)

### 2. Shift Layer
![Shift Layer](https://raw.githubusercontent.com/bonanto/rabiraag/main/Screenshots/Shift.png)

### 3. AltGr Layer (Right Alt)
![AltGr Layer](https://raw.githubusercontent.com/bonanto/rabiraag/main/Screenshots/Altgr.png)

### 4. AltGr + Shift Layer
![AltGr + Shift Layer](https://raw.githubusercontent.com/bonanto/rabiraag/main/Screenshots/Altgr_Shift.png)

---
## Other Screenshots 

### A. Touch Keyboard Support
Rabiraag is fully compatible with the Windows touch keyboard
![Touch Keyboard Support](https://raw.githubusercontent.com/bonanto/rabiraag/main/Screenshots/touch_keybord.png)

### B. The AltGr Helper in Task Manager - and Active Rabiraag Keyboard in Taskbar
Helper runs silently in the background, consuming virtually zero resources.
![Helper Process in Task Manager](https://raw.githubusercontent.com/bonanto/rabiraag/main/Screenshots/helper_process_1.png)

### C. Helper runs silently in the background, consuming virtually zero resources.
![Helper Process in Task Manager](https://raw.githubusercontent.com/bonanto/rabiraag/main/Screenshots/helper_process_2.png)

### D. VirusTotal Result for V3 Release EXE file. Check Hash there.
![VirusTotal Scan Result](https://raw.githubusercontent.com/bonanto/rabiraag/main/Screenshots/safe.png)
